...
for k = 1 : nframes
    ...
    noSmallStructures = bwareaopen(noSmallStructures, 150); %Remove small objects from image containing fewer then 150
    ...
    if ~isempty([stats.Area]) %Determine whether array is empty
